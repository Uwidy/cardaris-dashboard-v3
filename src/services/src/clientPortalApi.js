...
// Si tu définis VITE_PORTAL_API_URL dans .env, on l'utilise.
// Sinon, on reste en mode "DEMO" automatiquement.
const API_BASE_URL = import.meta.env.VITE_PORTAL_API_URL || null;
...
const demoOrders = [
  {
    ...
    description: "Précommande – Display Flammes Fantasmagoriques + accessoires.",
  },
  {
    id: "#CMD-0011",
    date: "05/11/2024",
